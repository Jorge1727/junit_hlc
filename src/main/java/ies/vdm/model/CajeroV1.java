...
public class CajeroV1 {
    ...
    public static void retirarFondos(Connection connection, String numCuenta) throws SQLException {
        Scanner scanner = new Scanner(System.in);
    ...
    public static void ingresarFondos(Connection connection, String numCuenta) throws SQLException {
        Scanner scanner = new Scanner(System.in);
    ...
    public static boolean verificarSaldoSuficiente(Connection connection, String numCuenta, double cantidad) throws SQLException {
    ...
    public static void realizarRetirada(Connection connection, String numCuenta, double cantidad) throws SQLException {
    ...
    public static void realizarIngreso(Connection connection, String numCuenta, double cantidad) throws SQLException {
        String insertMovimientoQuery = "INSERT INTO movimientos (num_cuenta, fecha, importe) VALUES (?, NOW(), ?)";
        String updateSaldoQuery = "UPDATE cuentas SET saldo_actual = saldo_actual + ? WHERE num_cuenta = ?";
    ...
    public static void consultarMovimientos(Connection connection, String numCuenta) throws SQLException {
    ...
    public static void listarCuentasCliente(Connection connection, String dniCliente) throws SQLException {
    ...
    public static void consultarInformacion(Connection connection, String dni) throws SQLException {
